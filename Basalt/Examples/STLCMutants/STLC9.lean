...
namespace STLCMutants.STLC9

open Expr Ty

/-- Bug 9: substTop_no_shift - doesn't shift at all in substTop -/
...
def substTop (s : Expr) (e : Expr) : Expr :=
  subst 0 s e  -- BUG: Should shift s and shift back result
