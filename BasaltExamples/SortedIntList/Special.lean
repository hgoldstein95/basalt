...
theorem List.genGappedFrom.terminates : ∀ (k n : Nat) (lo hi : Int),
  ...
  intro k n
  induction n <;> intro lo hi <;> refine SPMF.IsPMF.of_one_le ?_ <;> rw [List.genGappedFrom] <;>
    mass_bound <;> simp [ENNReal.div_self]
...
theorem List.genBoundedGapped.terminates (k maxLen : Nat) (maxVal : Int) :
  ...
  cases maxLen <;> rw [List.genBoundedGapped] <;> mass_bound <;>
